...
public class EndServiceFunctionCommand implements Command<ScriptExecutionResponse> {
  ...
  public EndServiceFunctionCommand continuationReference(ContinuationReference continuationReference) {
  ...
  public EndServiceFunctionCommand scriptExecutionId(String scriptExecutionId) {
    this.scriptExecutionId = scriptExecutionId;
    return this;
  }
  ...
  public EndServiceFunctionCommand executionId(String executionId) {
    this.executionId = executionId;
    return this;
  }
  ...
  public EndServiceFunctionCommand result(Object result) {
    this.result = result;
    return this;
  }

  public EndServiceFunctionCommand resultProperty(String propertyName, Object propertyValue) {
    if (result==null) {
