...
public class LockOperationRetry extends LockOperationExecution<ArgumentsExpressionExecution> {

  public LockOperationRetry(ContinuationReference continuationReference) {
