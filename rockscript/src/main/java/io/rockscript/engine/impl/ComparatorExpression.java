...
public class ComparatorExpression extends SingleExpression {

  SingleExpression left;
  SingleExpression right;
  String comparator;

  public ComparatorExpression(Integer id, Location location, SingleExpression left, SingleExpression right, String comparator) {
    super(id, location);
    this.left = left;
    this.right = right;
  ...
  public Execution createExecution(Execution parent) {
    return new ComparatorExpressionExecution(this, parent, comparator);
  }
