...
public class AssignmentExpression extends SingleExpression {
  ...
  public AssignmentExpression(Integer index, Location location, String operator, SingleExpression left, SingleExpression right) {
  ...
  public Execution createExecution(Execution parent) {
    return new AssignmentExpressionExecution(this, parent);
  }

  @Override
  protected List<? extends ScriptElement> getChildren() {
    return Lists.of((SingleExpression)left, right);
  }
